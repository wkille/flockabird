			...
			<div class="flex justify-between h-16">
				<div class="flex">
					...
					<div class="hidden sm:ml-6 sm:flex sm:space-x-8">
						...
						<!-- ref on each link then compute dynamic classes (for tailwind active classes) based on other classes (i.e. router-link-active) -->
						
						<router-link to="/blog" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
							The Blog
						</router-link>
						<router-link to="/about-me-jonathan-powell" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
							About Me
						</router-link>
						...
						<router-link to="/blog/new" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
							New Post
						</router-link>
					</div>
				</div>
					...
					<Menu as="div" class="ml-3 relative">
						<div>
							<MenuButton class="bg-white rounded-full flex text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
								...
								<img class="h-8 w-8 rounded-full" src="../../assets/jonathan-profile.jpg" alt="" />
							</MenuButton>
						</div>
			...
			<div class="pt-4 pb-3 border-t border-gray-200">
				<div class="flex items-center px-4">
					<div class="flex-shrink-0">
						<img class="h-10 w-10 rounded-full" src="../../assets/jonathan-profile.jpg" alt="" />
					</div>
					<div class="ml-3">
						<div class="text-base font-medium text-gray-800">Jonathan Powell</div>
						<div class="text-sm font-medium text-gray-500">jonathan@example.com</div>
					</div>
					<!--
