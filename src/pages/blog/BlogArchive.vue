...
<template>
	<div>
		...
		<section class="relative bg-gray-50 mt-4 pt-8 pb-20 px-4 sm:px-6 lg:pb-28 lg:px-8">
			...
			<div class="relative max-w-7xl mx-auto">
				...
				<div v-else-if="hasPosts" class="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
					<blog-item 
